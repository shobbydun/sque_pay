...
public class ScanItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemname = findViewById(R.id.name_good);
        itemcategory= findViewById(R.id.name_category);
        itemprice = findViewById(R.id.unit_price);
    ...
    public  void additem(){
        ...
        if(!TextUtils.isEmpty(itemnameValue)&&!TextUtils.isEmpty(itemcategoryValue)&&!TextUtils.isEmpty(itempriceValue)){
            ...
            itemprice.setText("");
            itembarcode.setText("");
            Toast.makeText(ScanItem.this,itemnameValue+" Added",Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(ScanItem.this,"Please Fill all the fields",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void Logout()
    {
        ...
        finish();
        startActivity(new Intent(ScanItem.this,LoginPage.class));
        Toast.makeText(ScanItem.this,"LOGOUT SUCCESSFUL", Toast.LENGTH_SHORT).show();
