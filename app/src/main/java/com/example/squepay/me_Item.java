...
public class me_Item extends AppCompatActivity {
    ...
    protected  void  onStart() {
        ...
        FirebaseRecyclerAdapter<Items, AddCart.UsersViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Items, AddCart.UsersViewHolder>
                (  Items.class,
                        ...
                        AddCart.UsersViewHolder.class,
                        mdatabaseReference )
        {
            @Override
            protected void populateViewHolder(AddCart.UsersViewHolder viewHolder, Items model, int position){
